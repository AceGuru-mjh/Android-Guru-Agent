...
100+ 个内置工具（v3 新增超时/重试/限流/熔断/追踪/批量/组合动作八层执行硬化）、PRoot 沙箱化 Ubuntu 终端、仿生认知记忆系统（差分摄取 → 轨迹蒸馏 →
...
<a href="#tools"><img src="https://img.shields.io/badge/🧰_tools-107-ff69b4" alt="107 Tools"/></a>
